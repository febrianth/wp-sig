...
class SettingsApiController
{
    ...
    public function handle_process_maps(WP_REST_Request $request)
    {
        ...
        $registration_flow_mode = $params['registration_flow_mode'] ?? 'qr_once';
        ...
        $result = $this->settings_service->process_uploaded_maps($file_urls, $key_mappings, $badge_thresholds, $registration_flow_mode);
